        ...
        public XTRMObject()
        {
            ...
            try
            {
                if (XTRMTASK != null)
                {
                    ...
                    {
                        // What to do here? regular connect("XTRMTASK")?
                    }
                }
                else
                {
            ...
            {
                pState = -1;
                XLogger(2500, ex.ErrorCode, string.Format("Connection={0}; Message={1}", "XTRMTASK", ex.Message));
            }
            catch (Exception ex)
            {
                pState = -1;
                XLogger(2501, -1, string.Format("Connection={0}; Message={1}", "XTRMTASK", ex.Message));
            }
        }
        public void Close()
        {

...
namespace XTRMlib
{
    ...
    public class XTRMTask : XTRMObject
    {
        ...
        Process taskProcess;
        public XTRMEvent origEvent = new XTRMEvent(false);
        ...
        public XTRMTask(bool bConnect = false, string strName = "XTRMTask")
            : base(bConnect, strName)
        {
            // Get the current process.
            //Process currentProcess = Process.GetCurrentProcess();
            if (strName.Equals("XTRMTask"))
            {
                className = strName;
            }
            else
            {
                className = strName + "::XTRMTask";
            }
        }
